...
Программа получает 5 натуральных чисел, не превышающих 2<sup>31</sup>-1. Для их хранения потребуется 5 переменных (`X`, `A`, `B`, `C`, `D`) типа `int`.
...
1. **Ввод данных:**  
   Программа считывает 5 натуральных чисел, обозначенные как `X`, `A`, `B`, `C` и `D`.
...
7. Тест на ограничения задачи (2147483647 = 2<sup>31</sup>-1):
   ...
   - **Input**:
        ```
        2147483646 2147483643 2147483646 2147483645 2147483647 
        ```
